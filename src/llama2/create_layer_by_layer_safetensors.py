...
if __name__ == "__main__":
    # src = "../llama2/models/llama2/01-base/13b/with_early_stopping_with_2_more_datasets_tol50/best/merged"
    # dest = "../llama2/models/llama2/01-base/13b/with_early_stopping_with_2_more_datasets_tol50/best/layers"
    src = Path("../llama2/models-on-a100/06/yes_or_no_as_answer_with_context/checkpoint-9200/merged")
